...
import { MeshGradient, GrainGradient } from "@/components/ambient/shaders";
        ...
        >
          ...
          <motion.section {...fadeUp(0, 24)} style={SECTION_BLOCK}>
            ...
            <p style={P}>
              ...
              or Berman Women's Wellness. A physician-patient
          ...
          <motion.section {...fadeUp(0, 24)} style={SECTION_BLOCK}>
            ...
            <p style={P}>
              Berman Women's Wellness may send customer care text
